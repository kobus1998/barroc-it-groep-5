    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="<?php echo BASE_URL ?>/development/public/html/register.php" class="navbar-brand" style="text-shadow: 1px 1px 1px black; color: gray;">Barroc IT / <span style="font-size: 12px;" ><?= $user->username; ?></span></a>
            </div>
